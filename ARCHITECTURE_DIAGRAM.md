...
│  │       │          │ │       │          │ │       │          │ │       │          │ │  (no ViewModel)  │ │
│  │       ▼          │ │       ▼          │ │       ▼          │ │       ▼          │ │  Typography,     │ │
│  │  ChatViewModel   │ │  ExploreViewModel│ │  DreamViewModel  │ │  PlanViewModel   │ │  Colors,         │ │
│  │  StateFlow:      │ │  StateFlow:      │ │  StateFlow:      │ │  StateFlow:      │ │  Components      │ │
│  │   Initial|Loading│ │   (locations,    │ │   Initial|Interp.│ │   Initial|Running│ │  (local state    │ │
│  │   |Success|Error │ │    filters,route)│ │   |Result|Error  │ │   |Result|Error  │ │   only)          │ │
│  └───────┬──────────┘ └───────┬──────────┘ └───────┬──────────┘ └───────┬──────────┘ └───────┬──────────┘ │
│          │ 9 use cases        │ 2 use cases        │ 3 use cases        │ 1 use case         │ 0 use cases│
└──────────┼────────────────────┼────────────────────┼────────────────────┼────────────────────┼────────────┘
           │                    │                    │                    │                    │
           ▼                    ▼                    ▼                    ▼                    │
┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
